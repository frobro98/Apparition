...
CORE_API Matrix4 ConstructOrthographicMatrix(f32 left, f32 right, f32 bottom, f32 top, f32 nearPlane, f32 farPlane);
CORE_API Matrix4 ConstructScreenTransformMatrix(f32 screenWidth, f32 screenHeight, f32 worldDepth = 1.f);

CORE_API Matrix4 ConstructFastInverseViewMatrix(const Vector4& position, const Quat& rotation);
CORE_API Matrix4 ConstructFastInversePerspectiveMatrix(const Matrix4& perspective);
//CORE_API Matrix4 ConstructInversePerspectiveMatrix(f32 fov, f32 aspectRatio, f32 nearPlane, f32 farPlane);
CORE_API Matrix4 ConstructFastInverseOrthographicMatrix(f32 width, f32 height, f32 nearPlane, f32 farPlane);
CORE_API Matrix4 ConstructFastInverseOrthographicMatrix(f32 left, f32 right, f32 bottom, f32 top, f32 nearPlane, f32 farPlane);
CORE_API Matrix4 ConstructFastInverseScreenMatrix(f32 screenWidth, f32 screenHeight, f32 worldDepth = 1.f);
...
CORE_API Matrix4 GetTransposeAdjointWithoutTranslation(const Matrix4& m);
}