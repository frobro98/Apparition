...
public:
	...
	friend CORE_API Vector4 operator*(const Vector4& v, const Matrix4& m);
	friend CORE_API Matrix4 operator*(f32 s, const Matrix4& m);

	friend CORE_API Vector4& operator*=(Vector4& v, const Matrix4& m);

	friend CORE_API bool operator==(const Matrix4& lhs, const Matrix4& rhs)
	{
