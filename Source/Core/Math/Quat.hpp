...
public:
	...
	friend CORE_API Matrix4& operator*=(Matrix4& m, const Quat& q);
	friend CORE_API Quat& operator*=(Quat& q, const Matrix4& m_);
	friend CORE_API Matrix4 operator*(const Matrix4& m, const Quat& q);
	friend CORE_API Matrix4 operator*(const Quat& q, const Matrix4& m_);

	friend CORE_API Vector4& operator*=(Vector4& v, const Quat& q);
	friend CORE_API Vector4 operator*(const Vector4& v, const Quat& q);
	friend CORE_API Vector4 operator*(const Quat& q, const Vector4& v);

	friend CORE_API Quat& operator+=(Quat& q, float val);
	friend CORE_API Quat& operator-=(Quat& q, float val);
	friend CORE_API Quat& operator*=(Quat& q, float val);
	friend CORE_API Quat& operator/=(Quat& q, float val);

	friend CORE_API Quat operator+(const Quat& q, float val);
	friend CORE_API Quat operator+(float val, const Quat& q);
	friend CORE_API Quat operator-(const Quat& q, float val);
	friend CORE_API Quat operator-(float val, const Quat& q);
	friend CORE_API Quat operator*(const Quat& q, float val);
	friend CORE_API Quat operator*(float val, const Quat& q);
	...
	friend CORE_API bool operator==(const Quat& lhs, const Quat& rhs)
	{
