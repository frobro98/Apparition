...
public:
	...
	friend CORE_API Vector2 operator*(const Vector2& v, const Matrix2& m);
	friend CORE_API Matrix2 operator*(float s, const Matrix2& m);
	friend CORE_API Vector2& operator*=(Vector2& v, const Matrix2& m);
